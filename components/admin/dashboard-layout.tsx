...
import { LogOut, Users, Calendar, UserCheck, Clock, User } from "lucide-react"
...
export function AdminDashboardLayout({ children, activeTab, onTabChange }: AdminDashboardLayoutProps) {
