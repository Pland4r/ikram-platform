...
export function StudentDashboardLayout({ children, activeTab, onTabChange }: StudentDashboardLayoutProps) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Badge variant="secondary">Student ({user?.uniqueCode})</Badge>
